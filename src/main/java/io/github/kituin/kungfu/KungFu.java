...
import io.github.kituin.kungfu.config.MiJiConfig;
...
public class KungFu {
    ...
    public static MiJiConfig miJiConfig;
    public KungFu() {
    ...
    private void enqueueIMC(final InterModEnqueueEvent event) {
        ...
        InterModComms.sendTo("KungFu", "helloworld", () -> {
    ...
    public static class KeybindingRegistry {
        ...
        public static void onClientSetup(FMLClientSetupEvent event) {
            event.enqueueWork(() -> ClientRegistry.registerKeyBinding(OpenGui.MESSAGE_KEY));
        }
    }

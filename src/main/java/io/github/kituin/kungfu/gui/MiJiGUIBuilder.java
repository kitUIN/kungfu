...
@OnlyIn(Dist.CLIENT)
public class MiJiGUIBuilder extends Widget {
    ResourceLocation OBSIDIAN_FIRST_GUI_TEXTURE = new ResourceLocation(Utils.MOD_ID, "textures/gui/miji.png");
    public MiJiGUIBuilder(int x, int y, int width, int height, ITextComponent title) {
    ...
    public void renderWidget(MatrixStack matrixStack, int mouseX, int mouseY, float partialTicks) {
        ...
        this.blit(matrixStack, this.x, this.y, (i-1) * 50, 0, this.width, this.height);
